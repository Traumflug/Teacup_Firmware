...
*/
#define ENDSTOP_CLEARANCE_X      1
#define ENDSTOP_CLEARANCE_Y      1
...
*/
#define MAX_JERK_X               60
#define MAX_JERK_Y               60
#define MAX_JERK_Z               60
#define MAX_JERK_E               60
