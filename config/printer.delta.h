...
/** \def KINEMATICS_STRAIGHT KINEMATICS_COREXY KINEMATICS_DELTA
  ...
  KINEMATICS_DELTA
    A bot using delta kinematics. Three parallel linear 
    actuators separated by 60 degrees angle. Used in Rostock,
    Kossel, and their derivatives.
*/
#define KINEMATICS               KINEMATICS_DELTA

#if KINEMATICS == KINEMATICS_DELTA
...
*/
#define DEFAULT_DELTA_DIAGONAL_ROD 156000
...
/** \def DEFAULT_DELTA_RADIUS
  ...
  length projected to horizontal axis (x-y plane).
    ...
    Unit is in micrometer.
*/
#define DEFAULT_DELTA_RADIUS     78120
...
*/
#define TOWER_X_ANGLE_DEG        211.2
#define TOWER_Y_ANGLE_DEG        331.7
#define TOWER_Z_ANGLE_DEG        90.0
#endif //KINEMATICS == KINEMATICS_DELTA
...
*/
#define STEPS_PER_M_X            210231
#define STEPS_PER_M_Y            210231
#define STEPS_PER_M_Z            210231
#define STEPS_PER_M_E            291840
...
*/
#define MAX_JERK_X               25
#define MAX_JERK_Y               25
#define MAX_JERK_Z               25
