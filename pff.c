...
/* Changes for Teacup:
  ...
  Initial pick up in Nov. 2014:
  - Fetched from from http://elm-chan.org/fsw/ff/00index_p.html (R0.03).
  - Replaced tabs with spaces. Formatting unchanged otherwise to keep
    diff-ability with original sources.
  - Renamed diskio.c/.h to pff_diskio.c/.h to avoid file name conflicts
    with other modules.
  - Renamed pffconf.h to pff_conf.h to align with the above rename.
