...
/// Fraction of the maximum feed that is to be used for low-speed (search) moves [-].
...
DEFINE_TEMP_SENSOR( extruder,	TT_THERMISTOR,	ANALOG_INPUT_1,		THERMISTOR_EXTRUDER)
//DEFINE_TEMP_SENSOR( bed,     	TT_THERMISTOR,	ANALOG_INPUT_2,		THERMISTOR_EXTRUDER)
...
//               name      		pin
DEFINE_HEATER( extruder,	PWM_OUTPUT_1)
//DEFINE_HEATER( bed,     	PWM_OUTPUT_2)
//DEFINE_HEATER( fan,     	PWM_OUTPUT_3)
