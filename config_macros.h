...
#define HOME_FEED_FAST_X			LIMIT_FEED( (HOME_FEED), MAXIMUM_FEEDRATE_X)
#define HOME_FEED_FAST_Y			LIMIT_FEED( (HOME_FEED), MAXIMUM_FEEDRATE_Y)
#define HOME_FEED_FAST_Z			LIMIT_FEED( (HOME_FEED), MAXIMUM_FEEDRATE_Z)
