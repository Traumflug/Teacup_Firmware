...
*/
//                                                      1000   step. micro teeth belt
#define	STEPS_PER_M_X					(1000UL * 200UL * 16UL / 16UL / 3UL)	
#define	STEPS_PER_M_Y					(1000UL * 200UL * 16UL / 16UL / 3UL) 
#define	STEPS_PER_M_Z					(1000UL * 200UL * 4UL * 4UL/5UL)      
/// http://blog.arcol.hu/?p=157 may help with this one
#define	STEPS_PER_M_E					(56250UL * 8UL)	//900000	//903400	//877744	//772415	//735632 //367816
...
Dzielnik /8
500 - ok
750, 1000 - slychac zgrzyty!!
*/
#define	MAXIMUM_FEEDRATE_X		(200 * 60)
#define	MAXIMUM_FEEDRATE_Y		(200 * 60)
#define	MAXIMUM_FEEDRATE_Z		(5 * 60)
#define	MAXIMUM_FEEDRATE_E		(30 * 60)
...
/**
	Home positions, in mm.
	Define them to your machine's endstops position and define where to go after homing (optional)
*/
#define X_MAX_ENDSTOP_POSITION	207.0
//#define X_MIN_ENDSTOP_POSITION
#define X_HOME_POSITION			X_MAX

#define Y_MAX_ENDSTOP_POSITION	197.5
//#define Y_MIN_ENDSTOP_POSITION
#define Y_HOME_POSITION			Y_MAX

#define Z_MAX_ENDSTOP_POSITION	217.4
//#define Z_MIN_ENDSTOP_POSITION
#define Z_HOME_POSITION			Z_MAX
...
*/
#define MAX_JERK_X (10 * 60)
#define MAX_JERK_Y (10 * 60)
#define MAX_JERK_Z 0			//18 = 0.3 * 60
#define MAX_JERK_E (5 * 60)
...
#define	X_ENABLE_PIN							DIO13
#define	X_INVERT_DIR
//#define	X_INVERT_MIN
//#define	X_INVERT_MAX
#define	X_INVERT_ENABLE                                                  DIO13	//for X, Y and maybe E

#define	Y_STEP_PIN							AIO4	//AIO3
#define	Y_DIR_PIN							DIO12	//AIO4
//#define	Y_MIN_PIN							DIO3	//AIO5
#define	Y_MAX_PIN						    DIO3
//#define	Y_ENABLE_PIN						DIO13
//#define	Y_INVERT_DIR
//#define	Y_INVERT_MIN
//#define	Y_INVERT_MAX
#define	Y_INVERT_ENABLE

#define	Z_STEP_PIN							DIO8	//DIO2
#define	Z_DIR_PIN							DIO7	//DIO3
//#define	Z_MIN_PIN						DIO4
#define	Z_MAX_PIN							DIO4
...
#define	E_STEP_PIN							AIO2	//DIO7
#define	E_DIR_PIN							AIO3	//DIO8
//#define E_ENABLE_PIN						DIO13	//AUX_1??
#define	E_INVERT_DIR
...
/*
 * PK Temperature average
 *
 * Counts of samples to be averaged
 */

#define TEMP_SAMPLES_TO_AVERAGE	32

/*
 * PK Time period betweend calling heater_tick function (pid refreshing) [1ms]
 * Comment it out to keep standard behavior (heater_tick called every 10ms)
 */
#define PID_REFRESH_TIME	250L
...
DEFINE_TEMP_SENSOR(extruder,  TT_THERMISTOR,  AIO6,      THERMISTOR_THERMISTOR_MF51B20_104F3950L32_WITH_560R_IN_SERIES /*THERMISTOR_EXTRUDER*/)
DEFINE_TEMP_SENSOR(bed,       TT_THERMISTOR,  AIO7,      THERMISTOR_THERMISTOR_MF51B20_104F3950L32_WITH_560R_IN_SERIES /*THERMISTOR_EXTRUDER*/)
...
DEFINE_HEATER(bed,      PD5,   1)
DEFINE_HEATER(fan,      PB1,   1)
...
/*
 * PK This option disable auto changing G-Code to G1
 * when X, Y, Z or E is seen in the command!
 * With this option turned off it works very bad
 * with RepetierHost and default settings. In this
 * case command "M117 ETE 1h (...)" causes unexpected
 * extrussion!
 */
#define DONT_BE_SMARTER_THAN_HOST
